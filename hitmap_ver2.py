...
fig1 = ax1.imshow(H, interpolation='none', origin='low', vmin=vmin,vmax=vmax)
...
fig2 = ax2.imshow(H1, interpolation='none', origin='low', vmin=vmin,vmax=vmax)
...
fig3 = ax3.imshow(H2, interpolation='none', origin='low', vmin=vmin,vmax=vmax)
