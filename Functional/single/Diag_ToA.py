...
# Define the bins with the step of 1.5625 or 1.5625*10 for better resolution
...
### set limits for the TOA signal manually where the is no trigger ###
# left__=time_new[0]-43
# right__=time_new[1879907]
# ax9.set_xlim(left__,right__)
...
plt.savefig('%s:Diag_ToA1.pdf' % shot)
plt.show()
