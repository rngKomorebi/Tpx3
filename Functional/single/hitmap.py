...
fig1 = axes[0].imshow(H_masked, interpolation='none', origin='low', vmin=vmin,vmax=vmax)
fig.colorbar(fig1, ax=axes[0], label="Hits", fraction=0.046, pad=0.04)
axes[0].set_title("Shot %s: Hitmap" % shot)
axes[0].set_xlabel("Pixels, x axis [-]")
axes[0].set_ylabel("Pixels, y axis [-]")

fig2 = axes[1].imshow(H1_masked, interpolation='none', origin='low', vmin=vmin,vmax=vmax)
fig.colorbar(fig2, ax=axes[1], label="Hits", fraction=0.046, pad=0.04)
axes[1].set_title("Hitmap, cluster=1")
axes[1].set_xlabel("Pixels, x axis [-]")
axes[1].set_ylabel("Pixels, y axis [-]")

fig3 = axes[2].imshow(H2_masked, interpolation='none', origin='low', vmin=vmin,vmax=vmax)
fig.colorbar(fig3, ax=axes[2], label="Hits", fraction=0.046, pad=0.04)
axes[2].set_title("Hitmap, cluster>1")
axes[2].set_xlabel("Pixels, x axis [-]")
axes[2].set_ylabel("Pixels, y axis [-]")
