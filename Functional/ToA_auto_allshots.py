...
# Plotting for all shots mentioned in the "shots.txt"
# =============================================================================
import numpy as np
...
for i in range (0, len(shots)):
    ...
    ### Check if the file exists, go on with the loop if False, skip if True ###
    # if os.path.isfile("Figures/%s:ToA_plt_test.pdf" %shot):
    ...
    #     shotss = np.array([row[index_shot] for row in Data_limits])
    ...
    # try:
    #     index_current_shot = np.where(shotss==shot)[0][0]
